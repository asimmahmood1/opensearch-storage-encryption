...
public interface L1BlockCache {
     ...
     */
    BlockCacheValue<RefCountedByteBuffer> acquireRefCountedValue(long blockOffset, BlockSlotTinyCache.CacheHitHolder hitHolder)
        throws IOException;

    default BlockCacheValue<RefCountedByteBuffer> acquireRefCountedValue(long blockOffset) throws IOException {
